        ...
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <div
                    ...
                    onClick={() => dispatch(decrementItem(item.cartId))}
                >
                    <svg
                        width="10"
                        height="10"
                ...
                <div
                    ...
                    onClick={() => dispatch(incrementItem(item.cartId))}
                >
                    <svg
                        width="10"
                        height="10"
            ...
            <div className="cart__item-remove">
                <div className="button button--outline button--circle" onClick={handleClickRemove}>
                    <svg
                        width="10"
                        height="10"
                        viewBox="0 0 10 10"
